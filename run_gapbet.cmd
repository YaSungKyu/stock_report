...
"C:\Users\2019439\.local\bin\claude.exe" -p "/gapbet" --dangerously-skip-permissions --allowedTools "Bash WebFetch WebSearch Read Write Edit Glob Grep Skill mcp__playwright__browser_navigate mcp__playwright__browser_snapshot mcp__playwright__browser_click mcp__playwright__browser_close" > "%LOGDIR%\gapbet_%TODAY%.log" 2>&1
